...
public class ExerciseApplication {
	...
	@Bean
	ApplicationRunner geoGraph(ReactiveRedisTemplate <String,String> template){
		return args -> {
			var sicily = " Sicily";
			var geoTemplate = template.opsForGeo();
			var mapOfPoints = Map.of(
					"messina",new Point(13.361389,38.11555556),
					"catania",new Point(15.0876269,37.502669),
					"Palermo",new Point(15.58333333,37.316667)
			);
